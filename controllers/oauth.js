...
const { naverOauthDataUrl, getNaverTokenUrl, getNaverUnlinkUrl } = require("../url.js");
...
module.exports = {
	...
	getByKakao: async (req, res) => {
		...
		const redirectUrl = state === "local" ? "http://localhost:5000/kakao/callback" : "http://ttot.netlify.app/payment";
